...
![equation](https://latex.codecogs.com/svg.latex?\mathbf{F}(u,s)=\underbrace{\mathbf{c}_1(u)-\mathbf{c}_2(s)}_{\Delta\mathbf{p}}+R\underbrace{(\mathbf{n}_1(u)-\mathbf{n}_2(s))}_{\Delta\mathbf{n}}=\mathbf{0})
