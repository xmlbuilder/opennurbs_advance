...
**Swung Surface Equation:**

Let the profile curve be defined as:
$$
C(u) = (x(u), y(u))
$$

Let the angular function be:
$$
\theta(v) \in [0, 2\pi]
$$

Then the swung surface is defined as:
$$
S(u, v) = (x(u) \cdot \cos(\theta(v)), x(u) \cdot \sin(\theta(v)), y(u))
$$
