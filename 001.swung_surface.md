...
$$
S(u,v) = (x(v)a(u),  x(v)b(u),  z(v))
$$

또는 극좌표 형태로

$$
S(u,v) = (\rho(u)x(v)\cos\theta(u),  \rho(u)x(v)\sin\theta(u),  z(v))
$$
...
$$
S_u = (x(v)a'(u),\; x(v)b'(u),\; 0), \quad 
S_v = (x'(v)a(u),\; x'(v)b(u),\; z'(v))
$$

법선 벡터:

$$
S_u \times S_v = (x b' z',\; -x a' z',\; x x'(a'b - b'a))
$$
